...
{
  header("Location:http://localhost/Root/fCloud/Login/Login.php");
}
if(!(isset($_SESSION['User'])) || $_SESSION['User']!="Manager")
{
  ...
  function showUser($x)
  {
    $p="style=\"background-image:url('http://localhost/Root/fCLOUD/User/Profile/".$x[1].".".$x[4]."')\"";
    ?>
  ...
  function showFeedback($x)
  {
    ...
    if($n>0)
    {
      ...
      $p="style=\"background-image:url('http://localhost/Root/fCLOUD/User/Profile/".$x[2].".".$row[4]."')\"";
    }
    else
    {
      $p="style=\"background-image:url('http://localhost/Root/fCLOUD/User/Profile/nouser.jpg')\"";
    }
    $read="";
    if($x[4]=="false")
    {
...
<body>
  ...
  <div class="sidemenu">
    ...
    <div class="menuitem" onclick="window.location='http://localhost/Root/fCLOUD/Home/index.php';">Home</div>
    <div class="menuitem" onclick="window.location='http://localhost/Root/fCLOUD/Desktop/index.php';">Desktop</div>
