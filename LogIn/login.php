...
div.blurbg
{
  ...
  top:50%;
  left:50%;
  background:url("http://localhost/Root/fCLOUD/Images/2.jpg"),radial-gradient(#8dddff,#0566a9);
...
<p class="noaccount"><a href="http://localhost/Root/fCLOUD/NewAccount/index.php">Don't have an Account ? &nbsp; Create One.</a></p>
<div class="buttonset">
<a href="http://localhost/Root/fCLOUD/Home"><input class="cancel" type="button" value="Cancel"></a>
