...
{
  header("Location:http://localhost/Root/fCloud/Desktop/index.php");
}
...
{
  $_SESSION['error']="2";
  header("Location:/Root/Log/login.php");
}
        ...
        if(isset($_POST['Login']))
        {
          ...
          else
          {
            ...
            else if($row[3]=="User")//Not Admin or Manager but Blocked
            {
              ...
              {
                header("Location:http://localhost/Root/fCloud/Blocked/index.php");
              }
              else
              {
                header("Location:http://localhost/Root/fCloud/Blocked/verify.php");
              }
            }
          }
        }
...
div.blurbg
{
  ...
  top:50%;
  left:50%;
  background:url("http://localhost/Root/fCLOUD/Images/3.jpg"),radial-gradient(#8dffdd,#05a966);
...
<p class="noaccount" style="display:none;"><a href="http://localhost/Root/fCLOUD/ResetPassword/">Forgot Password ?&nbsp; Reset Password.</a></p>
<div class="buttonset">
<a href="http://localhost/Root/fCLOUD/Login/Login.php"><input class="cancel" type="button" value="Back"></a>
<a href="http://localhost/Root/fCLOUD/Home"><input class="home" type="button" value="Home"></a>
...
<?php
  echo "<script>";
  echo "document.getElementById('avatar').style.backgroundImage=\"url('http://localhost/Root/fCLOUD/User/Profile/".$USER.".".$EXT."')\";";
?>
